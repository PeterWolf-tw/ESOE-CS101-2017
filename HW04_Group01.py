...
sound = wave.open("/Users/harry/Documents/GitHub/ESOE-CS101-2017/ESOE-CS101-2017/44100.wav")
...
if showAll == True:
    ...
    for i in range(0, nframes):
        ...
        newwaveData = int(waveData)/4
        newwaveData = bytes(newwaveData)
        tapeClip = struct.unpack("<h", newwaveData)
        print(tapeClip)
