...
# (a). 哪一種傳輸方式較為耗電？
print("Answer:藍芽的功率需求比WiFi低，因此裝置體積也較小，適用於消費電子產品。")
# (b). 哪一種傳輸方式較快速？
print("Answer:藍芽傳輸速度720kbps(千位元/秒)，Wi-Fi則為11mbps(百萬位元/秒)，速度上有明顯差距。")
...
print("Answer:手機型號：iphone 5,藍芽版本：4.0,理論速度：1Mbps,檔案大小：2.42MB,理論耗時：19.36sec")
print("實際耗時72秒 可能原因：其他裝置的藍芽/wifi等訊號干擾，或折射繞射等因素")
